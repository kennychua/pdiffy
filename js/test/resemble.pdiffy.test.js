describe('pdiffy', function(){
	...
	describe('original #compareTo() missing link', function(){
		it('should return true on data.isSameDimensions', function(done){
			resemble(testdata.google_original).compareTo(testdata.google_about_link_missing).onComplete(function(data) {
				expect(data.isSameDimensions).to.equal(true);
				done();
			});
		})
	...
	describe('original #compareTo() transparency over missing link', function(){
		it('should return true on data.isSameDimensions', function(done){
			resemble(testdata.google_original).compareTo(testdata.google_about_link_transparent).onComplete(function(data) {
				expect(data.isSameDimensions).to.equal(true);
				done();
			});
		})
	...
	describe('transparency over missing link #compareTo() original', function(){
		it('should return true on data.isSameDimensions', function(done){
			resemble(testdata.google_about_link_transparent).compareTo(testdata.google_original).onComplete(function(data) {
				expect(data.isSameDimensions).to.equal(true);
				done();
			});
		})
	...
	describe('transparency over missing link #compareTo() missing link', function(){
		it('should return true on data.isSameDimensions', function(done){
			resemble(testdata.google_about_link_transparent).compareTo(testdata.google_about_link_missing).onComplete(function(data) {
				expect(data.isSameDimensions).to.equal(true);
				done();
			});
		})
	...
	describe('missing link #compareTo() transparency over missing link', function(){
		it('should return true on data.isSameDimensions', function(done){
			resemble(testdata.google_about_link_missing).compareTo(testdata.google_about_link_transparent).onComplete(function(data) {
				expect(data.isSameDimensions).to.equal(true);
				done();
			});
		})
